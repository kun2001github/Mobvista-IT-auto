...
def generate_user_choice_hash(prog_id, sid):
    ...
    constant_string = "This is a constant string for example"
    
    data = f".{sid}{prog_id}{timestamp}{constant_string}".encode('utf-8')
    md5_hash = hashlib.md5(data).digest()
    custom_hash = md5_hash[:8]
    base64_encoded = base64.b64encode(custom_hash).decode('utf-8')
